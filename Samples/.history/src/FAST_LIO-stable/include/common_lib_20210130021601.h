...
MTK_BUILD_MANIFOLD(measurement_noise,
((vect1, v1))
);
*/
...
/*
 // supply system-specific measurement model: only for example, not used in this case
measurement get_h(state &s)
{
	measurement res;
	return res;
}
...
/*
// supply system-specific differentions of the measurement model: only for example, not used in this case
MTK::get_cross_cov<measurement, state>::type dh_dx(state &s)
{
	MTK::get_cross_cov<measurement, state>::type res = MTK::get_cross_cov<measurement, state>::type::Identity();
	return res;
}

MTK::get_cross_cov<measurement, measurement>::type dh_dv(state &s){
	MTK::get_cross_cov<measurement, measurement>::type res = MTK::get_cross_cov<measurement, measurement>::type::Identity();
	return res;
}
*/
// prepare ekf class
